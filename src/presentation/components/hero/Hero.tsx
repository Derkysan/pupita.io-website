      ...
      <div className="flex-1 relative z-50">
        <div className="grid grid-cols-1 max-w-10/12 lg:max-w-11/12 h-full mx-auto items-center">
          <div className="space-y-6">
            <h1 className="font-heading text-7xl lg:text-8xl tracking-tighter">
              <TextAnimate mode="letters" className="block font-thin leading-[1.2em]">Soluciones Tech</TextAnimate><br/>
              <TextAnimate mode="letters" className="block font-light leading-[1.2em]" delay={.25}>Profesionales</TextAnimate>
            </h1>
